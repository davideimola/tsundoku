...
Wish, pin an entry to the Pile, declare a Series collected. There is no generic update
and no `save()`: the vocabulary of writing is the owner's vocabulary, and it comes from
`CONTEXT.md`.
